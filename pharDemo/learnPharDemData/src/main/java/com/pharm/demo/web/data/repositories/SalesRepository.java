...
public interface SalesRepository extends JpaRepository<Sales, Long> {
    ...
    @Query("SELECT new com.pharm.demo.web.data.dto.SalesSumsDTO(count(s), sum(s.soldSum)) FROM Sales s " +
    ...
    @Query("SELECT new com.pharm.demo.web.data.dto.SalesSumsDTO(s.inventory.inventoryVersionNumber, count(s), sum(s.soldSum)) FROM Sales s" +
